    ...
    >
      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', border: '1px solid #1c2a47', background: '#0f1629', color: '#94a3b8', transition: 'all .2s' }}
        >
          🧠 Content DNA
        </button>
        <button
          onClick={() => router.push('/setup')}
          style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', border: 'none', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: '#fff', boxShadow: '0 4px 20px rgba(99,102,241,.35)', transition: 'all .2s' }}
        >
          🔄 Re-analyse
        </button>
      </div>
